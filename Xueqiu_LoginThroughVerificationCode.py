...
#         #opt.add_experimental_option('w3c', False)#这行似乎有bug
...
#                 f.write(cookie_dict)
#             # with open('D:\zzb\xueqiu_cookie.txt', 'w', encoding='utf8')as f:
#             #     cookie_dict = json.dumps(cookie_dict)
#             #     f.write(cookie_dict)
#             return cookie_dict
#         except:
...
#         # image1 = self.get_yzm_img("xq1.png")
#         # 点按呼出缺口
#         slider = self.get_slider()
#         # slider.click()
#         # 获取带缺口的验证码图片
#         # image2 = self.get_yzm_img('xq2.png')
...
#     crack = Login()
#     crack.run()
#     c = crack.return_cookie()
#     print(c)
def return_xueqiu_cookie():
    class Login(object):
        def __init__(self):
            self.url = 'https://xueqiu.com/'
            #s=Service(executable_path='./chromedriver.exe')
