...
def autoBuyAndSold(str,ZuHe_Name,ZuHe_list):
    ...
    try:
        configuration2_button=driver.find_element_by_xpath('/html/body/div[5]/div/div/div/div[2]/button[1]')
        driver.execute_script("arguments[0].click();", configuration2_button)
        time.sleep(0.2)
    except:
        pass
    time.sleep(0.4)
...
ZuHe_list=['ZH3068612','ZH2579014','ZH2531440','ZH2263951']#要监控的组合列表
#while 1:
for ZuHe_Name in ZuHe_list:
    ...
    old_file = ZuHe_Name + "_" + "" + current_fileName + ".txt"
    ...
    if trade_new!=trade_old:
        ...
        autoBuyAndSold(trade_new,'ZH2311106',ZuHe_list)#要调仓的组合
    time.sleep(0.5)
